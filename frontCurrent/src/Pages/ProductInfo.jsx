            ...
            <Row>
                ...
                <Col md={3}>
                    <ListGroup variant="flush">
                        ...
                        <ListGroup.Item>{product.quantity > 0 ? (
                            <Badge bg="success">In Stock</Badge>
                        ) : (
                            <Badge bg="danger">Out Of Stock</Badge>
                        )}</ListGroup.Item>

                        <ListGroup.Item>{product.quantity > 0 ? (<button onClick={() => handleClick(product)}>Add To Cart</button>):(
                            <button >Unavailable</button>)}</ListGroup.Item>
                    </ListGroup>
                </Col>
            </Row>
        </div>
